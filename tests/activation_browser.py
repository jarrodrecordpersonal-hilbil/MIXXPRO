        ...
        try:
            ...
            with sync_playwright() as p:
                ...
                try:
                    ...
                    expect(page.locator('nav [data-extension="music"]')).to_be_visible();page.locator('nav [data-extension="music"]').click();expect(page.get_by_role('heading',name='Add music without changing your MIXX.')).to_be_visible();passed('Music setup is reachable from the existing venue dashboard')
