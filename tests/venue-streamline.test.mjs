...
for(const page of ['home','mixx','tvs','revenue','themes','admin','brands'])test(`active ${page} wins over the unchanged root URL`,()=>assert.equal(resolvePage({activePage:page,pathname:'/'}),page));
